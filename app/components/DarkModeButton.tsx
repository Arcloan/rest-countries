...
export default function DarkModeButton(){
    return (
        <button onClick={() => document.documentElement.classList.toggle("dark")} className="hover:cursor-pointer font-semibold flex gap-2 items-center">
            <svg className="dark:fill-white inline w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
