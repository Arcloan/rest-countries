...
export default function Search() {
    ...
    return(
        <form onSubmit={(e) => e.preventDefault()} className="max-w-[90%] mt-8 mx-auto flex flex-col max-lg:gap-4 lg:flex-row lg:justify-between lg:items-center">
            ...
            />
            <select value={selectValue} name="region" ref={selectField} id="" onChange={handleSelectionChange} aria-label="Region name" className="w-max py-2 px-6 bg-white rounded shadow-xl">
